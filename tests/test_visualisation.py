...
def test_visualisation_output_type(sample_data):
    ...
    result = visualisation(**sample_data)
...
def test_visualisation_different_data():
    ...
    result = visualisation(
        "Sample Test Data", "Year", "Population",
        ['2050', '2060', '2070', '2071'],
...
def test_visualisation_single_data_point():
    ...
    result = visualisation("Single Point", "Year", "Population", ["2022"], [1000.0])
    assert isinstance(result, str)
    assert len(result) > 0
...
def test_visualisation_different_data_produces_different_images():
    ...
    result1 = visualisation(
        "Quarterly Sales", "Quarter", "Revenue",
        ['Q1', 'Q2', 'Q3', 'Q4'],
        [1200.5, 1500.75, 1800.0, 2100.25]
    )
    result2 = visualisation(
